...
void generate_svg(const char *filename, IrregularQuadrilateral large_quad,
    ...
    // Start SVG
    fprintf(file, "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"500\" height=\"500\" viewBox=\"0 0 150 150\">\n");
...
int main() {
    ...
    RotatedRectangle small_rects[] = {
        {{64.311, 77.657}, 6.702, 6.702, 0.0},
        {{40.365, 81.172}, 11.354, 11.354, 0.0},
        {{21.601, 101.087}, 11.354, 11.354, 0.0},
        {{50.448, 123.934}, 10.157, 9.609, 0.102},
        {{4.668, 115.067}, 6.917, 14.163, 0.11},
        {{14.153, 123.648}, 12.5, 2.6, 0.101},
        {{52.68, 64.11}, 25.92, 25.86, 0.72},
        {{17.34, 62.94}, 34.12, 64.92, 0.0},
        {{33.764, 118.498}, 24, 17, 0.101}}; // coop
